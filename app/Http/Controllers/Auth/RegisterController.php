...
class RegisterController extends Controller
{
    ...
    /**
     * Show email OTP verification form
     */
    ...
    /**
     * Link guest orders to newly registered user based on phone or email match
     */
    private function linkGuestOrders(User $user): void
    {
        ...
        foreach ($guestOrders as $order) {
            ...
            // Also link the address to the user if it's unlinked
