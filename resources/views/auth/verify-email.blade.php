...
<div class="min-h-[75vh] flex items-center justify-center px-4 py-16">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Verify your email address</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="text-center mt-5 pt-5 border-t border-gray-100">
                ...
                <form method="POST" action="{{ route('verify.email.resend') }}" class="inline">
                    @csrf
                    <button type="submit" class="text-sm font-semibold text-espresso-700 hover:text-espresso-500 transition">
                        Resend OTP
                    </button>
                </form>
            </div>
