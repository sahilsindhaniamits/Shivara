    ...
    <div class="grid lg:grid-cols-5 gap-12">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gold-100 shadow-sm">
                ...
                <p class="text-sm text-espresso-500">{{ config('shivara.address.city', 'Jaipur') }}, {{ config('shivara.address.state', 'Rajasthan') }}</p>
            </div>

            <div class="bg-white p-6 rounded-2xl border border-gold-100 shadow-sm">
                <h3 class="text-sm font-bold text-espresso-700 mb-3">Follow Us</h3>
                <div class="flex gap-3">
                    <a href="https://www.instagram.com/theshivara" target="_blank" class="w-10 h-10 rounded-xl bg-gray-100 hover:bg-gold-50 flex items-center justify-center text-espresso-400 hover:text-gold-600 transition">
