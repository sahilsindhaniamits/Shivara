...
<div class="max-w-2xl">
    ...
    <form method="POST" action="{{ route('admin.coupons.store') }}" class="bg-white p-6 rounded-2xl border border-slate-100 space-y-4">
        ...
        <div class="flex gap-3 pt-2">
            <button type="submit" class="px-6 py-3 text-white" style="background-color:#c06d22 font-semibold rounded-xl hover:opacity-90 transition text-sm">Create Coupon</button>
