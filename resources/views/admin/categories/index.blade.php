...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.categories.create') }}" class="px-4 py-2.5 bg-brand-600 text-white text-sm font-semibold rounded-xl hover:bg-brand-700 transition flex items-center gap-1.5">
