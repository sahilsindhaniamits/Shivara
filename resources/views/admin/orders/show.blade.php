        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="mb-4 space-y-2">
                    ...
                    <a href="https://shazam.velocity.in" target="_blank" class="w-full px-4 py-2.5 text-sm font-bold rounded-xl transition flex items-center justify-center gap-2 border-2" style="color:#16a34a; border-color:#16a34a;">
