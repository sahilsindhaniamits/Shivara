...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.banners.create') }}" class="px-4 py-2.5 text-white" style="background-color:#c06d22 text-sm font-semibold rounded-xl hover:opacity-90 transition flex items-center gap-1.5">
