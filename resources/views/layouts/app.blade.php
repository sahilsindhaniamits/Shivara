...
<body class="min-h-screen flex flex-col">
    ...
    <a href="https://wa.me/{{ config('shivara.whatsapp') }}?text=Hi, I have a question about Shivara products" target="_blank"
       class="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-xl hover:bg-green-600 hover:scale-110 transition-all duration-300 animate-float">
