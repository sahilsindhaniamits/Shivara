    ...
    <aside :class="sidebar ? 'w-64' : 'w-[72px]'" class="fixed inset-y-0 left-0 bg-dark z-50 transition-all duration-300 hidden lg:block overflow-hidden">
        ...
        <nav class="p-3 space-y-0.5 mt-2">
            @php $nav = [
                ...
                ['route'=>'admin.product-banners.index','icon'=>'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z','label'=>'Product Banners'],
            ]; @endphp
            @foreach($nav as $item)
